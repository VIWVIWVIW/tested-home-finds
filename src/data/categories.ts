...
export const categories: Category[] = [
  { name: "Kitchen", slug: "kitchen", icon: "🍳", description: "Cookware, appliances & kitchen essentials", testCount: 10 },
  { name: "Cleaning", slug: "cleaning", icon: "🧹", description: "Vacuums, mops & cleaning supplies", testCount: 10 },
